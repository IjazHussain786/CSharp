...
namespace Twitter.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ApplicationUserManager UserManager
        {
            get
            {
                return this.userManager ?? this.HttpContext.GetOwinContext().
        ...
        public async Task<ActionResult> VerifyCode(string provider, string returnUrl, bool rememberMe)
        {
            ...
            return this.View(new VerifyCodeViewModel { Provider = provider,
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            var result = await this.SignInManager.
                    TwoFactorSignInAsync(model.Provider, model.Code, isPersistent:  model.RememberMe, 
        ...
        public async Task<ActionResult> SendCode(string returnUrl, bool rememberMe)
        {
            ...
            return this.View(
                new SendCodeViewModel { Providers = factorOptions,
                    ReturnUrl = returnUrl, RememberMe = rememberMe });
        }
        ...
        public async Task<ActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            return this.RedirectToAction("VerifyCode", 
                new { Provider = model.SelectedProvider, ReturnUrl = model.ReturnUrl,
