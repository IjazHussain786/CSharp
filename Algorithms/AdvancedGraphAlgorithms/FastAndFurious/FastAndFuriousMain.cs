...
public class FastAndFuriousMain
{
    ...
    public static void Main()
    {
        ...
        foreach (var car in cars)
        {
            ...
            for (int firstCamera = 0; firstCamera < cameras.Count; firstCamera++)
            {
                ...
                {
                    TimeSpan time = cameras[secondCamera].RecordingTime - cameras[firstCamera].RecordingTime;
    ...
    private static void ReadInput()
    {
        ...
        while ((line = Console.ReadLine()) != "Records:")
        {
            ...
            Road road = new Road(lineParts[0], lineParts[1], double.Parse(lineParts[2]), double.Parse(lineParts[3]));
        ...
        while ((line = Console.ReadLine()) != "End")
        {
            ...
            CarInfo carInfo = new CarInfo(lineParts[0], DateTime.Parse(lineParts[2]));
