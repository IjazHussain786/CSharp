...
{
    private static IDictionary<char, HashSet<char>> graph = new Dictionary<char, HashSet<char>>();
    private static HashSet<char> visited = new HashSet<char>();
    private static SortedSet<long> results = new SortedSet<long>();
    ...
    private static void AddNumbers(char currentNumber, string result)
    {
