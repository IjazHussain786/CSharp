...
namespace FootballBetting.Models.Attributes
{
    ...
    {
        private readonly int passMinLen;
        private readonly int passMaxLen;

        public PasswordAttribute(int passwordMinLen = 0, int passwordMaxLen = 30)
        {
            this.passMinLen = passwordMinLen;
            this.passMaxLen = passwordMaxLen;
        }
        ...
        public override bool IsValid(object value)
        {
            ...
            if (passAsString.Length < this.passMinLen || passAsString.Length > this.passMaxLen 
                || this.passMinLen > this.passMaxLen)
            {
                return false;
            }
