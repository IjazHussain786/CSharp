...
namespace ExamPreparation_Capitalism.Employees
{
    ...
    {
        public CleaningLady(string firstName, string lastName, PositionType position, 
        ...
        public override decimal Salary
        {
            get
            {
                return (this.WorksInDepartment.DefaultSalaryPercentage - 3) / 100m * this.WorksInCompany.CEO.Salary;
            }
        }
    }
}
